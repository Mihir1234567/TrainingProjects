...
const ShopWithoutSidebar = () => {
    ...
    return (
      <div key={product.id} className="flex flex-col group cursor-pointer">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-6 flex items-center justify-center gap-2 z-20 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
            <button className="bg-white hover:bg-[#C59B87] hover:text-white text-gray-800 w-11 h-11 rounded-full flex items-center justify-center shadow-[0_2px_10px_rgba(0,0,0,0.08)] transition-colors">
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white">
      ...
      {/* Page Header */}
      <div className="bg-[#FAF8F5] py-20 md:py-24 text-center">
          ...
          <div className="flex items-center w-full md:w-auto p-4 md:px-6 md:py-3 md:border-r border-gray-100 bg-white md:bg-transparent">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`p-1 flex gap-[3px] transition-colors ${viewMode === 2 ? "text-[#C59B87]" : "text-gray-300 hover:text-gray-600"}`}
              >
                <div className="w-[3px] h-4 bg-current"></div>
                <div className="w-[3px] h-4 bg-current"></div>
              </button>
              <button
                onClick={() => setViewMode(3)}
                className={`p-1 flex gap-[3px] transition-colors ${viewMode === 3 ? "text-[#C59B87]" : "text-gray-300 hover:text-gray-600"}`}
              >
              ...
              <button
                ...
                className={`p-1 flex gap-[3px] transition-colors ${viewMode === 4 ? "text-[#C59B87]" : "text-gray-300 hover:text-gray-600"}`}
              >
                <div className="w-[2px] h-4 bg-current"></div>
                <div className="w-[2px] h-4 bg-current"></div>
                <div className="w-[2px] h-4 bg-current"></div>
              ...
              <button
                ...
                className={`p-1 flex gap-[3px] transition-colors ${viewMode === 5 ? "text-[#C59B87]" : "text-gray-300 hover:text-gray-600"}`}
              >
                <div className="w-[2px] h-4 bg-current"></div>
                <div className="w-[2px] h-4 bg-current"></div>
                <div className="w-[2px] h-4 bg-current"></div>
