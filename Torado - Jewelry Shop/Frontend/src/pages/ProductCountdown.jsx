    ...
    <div className="min-h-screen flex flex-col font-sans bg-white">
      ...
      <div className="bg-gradient-to-b from-[#F5F0EB] to-white pt-28 pb-14 md:pt-36 md:pb-20 text-center">
        ...
        <div className="flex items-center justify-center gap-1.5 text-[14px] text-gray-500 font-medium">
          ...
          <span className="text-gray-400">/</span>
          <span className="text-[#C59B87]">Product Countdown</span>
        </div>
      </div>
      ...
      <main className="container mx-auto px-4 max-w-7xl py-8 md:py-16">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 flex flex-col md:flex-row gap-4">
            {/* Thumbnails */}
            <div className="flex flex-row md:flex-col gap-3 md:gap-4 w-full md:w-[100px] shrink-0 order-2 md:order-1 overflow-x-auto snap-x scrollbar-hide pb-2 md:pb-0">
              {thumbnailImages.map((img, idx) => (
                <div key={idx} onClick={() => { setIsTransitioning(true); setSlideIndex(idx + 1); }} className={`w-20 md:w-full aspect-square shrink-0 snap-start bg-[#F7F6F5] flex items-center justify-center p-2 cursor-pointer transition-all ${currentActualIndex === idx ? 'border border-[#C59B87]' : 'border border-transparent hover:border-gray-200'}`}>
            ...
            <div 
              className="relative flex-1 min-w-0 bg-[#F7F6F5] aspect-square flex items-center justify-center p-6 md:p-10 group overflow-hidden order-1 md:order-2 cursor-grab active:cursor-grabbing"
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex items-center gap-3 mb-6 flex-wrap">
              <div className="border border-[#D8A790]/30 rounded px-4 py-2 bg-[#F7F6F5]">
                <span className="text-[13px] font-medium text-gray-500">Hurry up! Sale ends in</span>
              </div>
              <div className="flex items-center gap-1.5">
                <div className="w-10 h-10 md:w-11 md:h-11 bg-[#CB927A] flex items-center justify-center text-white font-medium text-[15px] shadow-sm tracking-wider">
                  {String(timeLeft.days).padStart(2, '0')}
                </div>
                <span className="text-[#CB927A] font-medium text-lg">:</span>
                <div className="w-10 h-10 md:w-11 md:h-11 bg-[#CB927A] flex items-center justify-center text-white font-medium text-[15px] shadow-sm tracking-wider">
