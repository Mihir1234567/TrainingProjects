...
const ShopRightSidebar = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white">
      ...
      {/* Main Content */}
      <main className="container mx-auto px-4 max-w-7xl py-16 flex flex-col lg:flex-row-reverse gap-10">
