// ProductLayoutLeftThumbs.jsx - Thumbnails on the left
...
export const ProductLayoutRightThumbs = () => {
  ...
  const handleViewProduct = (product) => {
    ...
    try {
      ...
      // fallback: assign
      window.location.assign(`/productPageClassic?productId=${product.id}`);
    }
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col lg:flex-row gap-12 bg-white rounded-lg">
          ...
          <div className="lg:w-1/2 flex flex-row items-start gap-4">
            {/* Main Image Slider Container - Flex-grow to fill remaining space */}
            <div
              className="flex-1 relative select-none bg-gray-100 rounded-lg overflow-hidden"
            ...
            >
                ...
                {thumbnailUrls.map((url, index) => (
                  ...
                  >
                    <img
                      ...
                      onError={() => console.log("Image load error:", url)}
                    />
                  </div>
                ))}
              </Slider>
              ...
              <div
                ...
                onClick={() => mainImageSliderRef.current?.slickPrev()}
                aria-label="Previous image"
              >
                ...
                <div
                  className="absolute top-0 left-0 w-full h-full
                                                ...
                                                bg-gradient-to-r from-black/80 to-transparent rounded-lg"
                />
              </div>
              ...
              <div
                ...
                onClick={() => mainImageSliderRef.current?.slickNext()}
                aria-label="Next image"
              >
                ...
                <div
                  className="absolute top-0 right-0 w-full h-full 
                                                opacity-0 group-hover:opacity-100 transition-opacity duration-500
                                                bg-gradient-to-l from-black/80 to-transparent rounded-lg"
                />
              </div>
            ...
            {/* Thumbnail Gallery - Vertical column on RIGHT */}
            <div className="flex flex-col gap-2 flex-shrink-0">
              {thumbnailUrls.map((url, index) => (
                <img
                  ...
                  className={`w-16 h-auto object-cover rounded-md cursor-pointer border-2 
                                        ${
          ...
          <div className="lg:w-1/2">
            ...
            <div className="text-gray-700 mb-8">
              ...
              <p className="line-clamp-3">
                ...
                about the enduring legacy of first love, and the decisions that
                haunt us forever. 1996 was the year that changed everything for
                Maggie Dawes. Sent away at sixteen to live with an aunt she
                barely knew in Ocracoke, a remote village on North Carolina's
                Outer Banks, she could think only of the friends and family she
                left behind . . . until she met Bryce Trickett, one of the few
                teenagers on the island. Handsome, genuine, and newly admitted
                to West Point, Bryce showed her how much there was to love about
                the wind-swept beach town--and introduced her to photography, a
                passion that would define the rest of her life. A collection of
                10 well-researched board books to introduce a wide range of
                learning topics and everyday objects to the little scholars. The
                topics included in the set are - ABC, Numbers, Shapes, Colours,
                Wild Animals, Farm Animals and Pets, Birds, Fruits, Vegetables
                and Transport.
              </p>
            </div>
            <hr className="h-px my-3 bg-gray-200 border-0 dark:bg-gray-300" />
          ...
          {activeTab === "Additional Information" && (
            <div>
              <p className="mb-4 opacity-80">
                ...
                <p>
                  environmentally friendly printing processes to the development
                  of{" "}
                </p>{" "}
              ...
              {reviewSubmitted && (
                <div className="w-full max-w-4xl mx-auto p-4 mb-8 bg-green-50 border-2 border-green-200 rounded-lg">
                  ...
                  <p className="text-sm text-green-700 mb-4">
                    Thank you! Please refresh the page in a few moments to see
                    your review. You can remove or edit your review by logging
                    into{" "}
                    <a
                      href="#"
