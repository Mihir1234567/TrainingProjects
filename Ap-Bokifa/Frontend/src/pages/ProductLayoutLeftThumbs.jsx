...
export const ProductLayoutLeftThumbs = () => {
      ...
      return (
        <div>
          <p className="mb-4">
            ...
            Maggie Dawes. Sent away at sixteen to live with an aunt she barely
            knew in Ocracoke, a remote village on North Carolina's Outer Banks,
            she could think only of the friends and family she left behind . . .
            until she met Bryce Trickett, one of the few teenagers on the
            island.
          </p>
          <p>
            Handsome, genuine, and newly admitted to West Point, Bryce showed
            her how much there was to love about the wind-swept beach town--and
            introduced her to photography, a passion that would define the rest
            of her life. A collection of 10 well-researched board books to
            introduce a wide range of learning topics and everyday objects to
            the little scholars. The topics included in the set are - ABC,
            Numbers, Shapes, Colours, Wild Animals, Farm Animals and Pets,
          ...
          <div className="flex space-x-6 mt-6 text-sm text-gray-500">
            <span
              ...
              onClick={(e) => {
                e.preventDefault();
                setSidebarContent("ShippingReturns");
              }}
            >
            ...
            <span
              ...
              onClick={(e) => {
                e.preventDefault();
                setSidebarContent("SecurePayment");
              }}
            >
              <img
      ...
      return (
        <div>
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              setSidebarContent("Sustainability");
            }}
          >
          ...
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 py-4">
            <div className="flex flex-col lg:flex-row gap-12 bg-white rounded-lg">
              ...
              <div className="lg:w-1/2 flex flex-row items-start gap-4">
                {/* Thumbnail Gallery - Vertical column on left */}
