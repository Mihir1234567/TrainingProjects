...
// 1. Find the specific products from your data file
const product1 = ALL_PRODUCTS.find((p) => p.title === "ERASURE"); // id: 20
const product2 = ALL_PRODUCTS.find((p) => p.title === "The Wedding People"); // id: 1

// We filter out any potential 'undefined' if a product wasn't found
const upsellProducts = [product1, product2].filter(Boolean);
            ...
            <div className="relative w-full max-w-2xl bg-white rounded-lg shadow-xl p-6 sm:p-8">
                ...
                <div className="text-center mb-6">
                    <p className="text-gray-700 text-lg max-w-lg mx-auto leading-relaxed">
                        <strong className="text-gray-900">Upselling</strong> is
                        by far one of the best ways to boost sales in your
                        ecommerce store. It doesn't even require a lot of
                        additional work! On average,{" "}
                        <strong className="text-gray-900">
                            upselling is considered to be 20 times more
                            effective
                        </strong>
                        .
                    </p>
