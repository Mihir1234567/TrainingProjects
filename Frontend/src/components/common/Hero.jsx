...
const styles = {
  ...
  searchBoxContainer: `w-full bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex items-center mb-8 flex-col p-3 gap-2 sm:grid sm:grid-cols-2 sm:gap-2 sm:p-[15px] xl:flex xl:flex-row xl:p-3 xl:gap-2`,
        ...
        <div className={styles.contentWrapper}>
          <div className={styles.leftColumn}>
            ...
            <div className={styles.searchBoxContainer}>
              ...
              <div className={styles.searchBoxItemLast}>
                <Grid className={styles.icon} size={16} />
                <select
                  className={`${styles.inputField} appearance-none cursor-pointer`}
                >
