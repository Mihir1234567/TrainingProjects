...
const Navbar = () => {
  ...
  return (
    <header className="h-18 lg:h-22.5 w-full bg-white border-b border-slate-200 sticky top-0 z-50 flex items-center transition-all duration-300 ease-in-out">
      <div className="w-full px-6 lg:px-12 flex items-center justify-between transition-all duration-300 ease-in-out">
        ...
        <div className="hidden lg:flex items-center gap-6 font-semibold shrink-0">
          <Link
            to="/login"
            className="text-torado-green-600 hover:text-torado-green-500 font-semibold transition-colors text-[11px] xl:text-sm"
          >
            Login / Register
          </Link>
          ...
          <Link
            to="/post-job"
            className="hidden xl:inline-flex relative overflow-hidden group items-center justify-center py-2.5 px-7 rounded-lg font-semibold text-sm whitespace-nowrap bg-[#5B6CF6] text-white shadow-sm hover:shadow-md transition-all"
          >
          ...
          <button className="hidden xl:inline-flex relative overflow-hidden group items-center justify-center py-2.5 px-7 rounded-lg font-semibold text-sm whitespace-nowrap border border-torado-green-600 text-black bg-white shadow-sm hover:shadow-md transition-all">
            <span className="absolute inset-0 w-full h-full bg-[#083E47] scale-x-0 group-hover:scale-x-100 transition-transform duration-700 ease-in-out origin-center"></span>
      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto py-6 px-6 flex flex-col gap-2">
            ...
            <NavDropdownMobile to="/pages" title="Pages" onClick={toggleMenu} />
...
const NavDropdown = ({ title, to, items = [] }) => (
  <div className="relative group h-full flex items-center">
    <NavLink
      to={to}
      className={({ isActive }) =>
        `flex items-center gap-1 font-bold transition-all duration-300 ease-in-out text-xs xl:text-base py-4 ${
          isActive
